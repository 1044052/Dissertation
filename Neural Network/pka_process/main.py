...
def preprocess_expt_data():
    ...
    cleaned_csv = '../data/test_csv_dir/final_expt_pka.csv'
    ...
    save_pdb_directory = '../data/test_pdb_dir'
    # download_pdb_from_csv(csv_filename=cleaned_csv, save_pdb_directory=save_pdb_directory)

    # extract single chain
    single_chain_pdb_dir = '../data/preprocess_temp_data/EXPT_temp_data/data_pdb_expt_single_chain'
    ...
    fixed_pdb_directory = '../data/preprocess_temp_data/EXPT_temp_data/data_pdb_WT_fixed/'
    fix_pdb_batch(single_chain_pdb_dir, fixed_pdb_directory)

    # crop WT protein pdb files with radii 10
    crop_pdb_directory = '../data/preprocess_temp_data/EXPT_temp_data/data_pdb_WT_ires'
    wrong_ires_info_file = '../data/preprocess_temp_data/EXPT_temp_data/wrong_ires_WT.txt'
    center_coors_dir = '../data/preprocess_temp_data/center_coors_csv/'
    ...
    # protonate and charge titrable residues
    ires_mol2_dir = '../data/preprocess_temp_data/EXPT_temp_data/data_pdb_WT_ires_mol2'
    protonated_and_charged(crop_pdb_directory, ires_mol2_dir)

    # devide train, val, test set.
    devide_save_dir = '../data/preprocess_temp_data/EXPT_temp_data/WT_ires_mol2_devide/'
    train_weight = 0
    val_weight = 0
    test_weight = 1
    devide_train_val_test_set(input_pdb_dir=ires_mol2_dir, output_pdb_dir=devide_save_dir,
    ...
    protein_format = 'mol2'
    csv_directory = '../data/preprocess_temp_data/features_csv'
    proteins = [os.path.join(devide_save_dir, 'train'),
                os.path.join(devide_save_dir, 'val'),
                os.path.join(devide_save_dir, 'test')]
    for protein in proteins:
    ...
    # protonate and charge proteins
    protein_mol2_dir = '../data/preprocess_temp_data/EXPT_temp_data/data_pdb_WT_fixed_mol2/'
    ...
    csv_directory = '../data/preprocess_temp_data/fixed_single_chain_features_csv'
    save_protein_features_as_csv(protein=protein_mol2_dir, protein_format=protein_format, output_dir=csv_directory)
    print('finished process')
