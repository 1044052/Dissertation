...
def fix_pdb_file(source_pdb_path, target_pdb_path):
    ...
    charmm_inp_file = './charmm_script/step1_pdbreader.inp'
    temp_charmm_inp_file = './charmm_script/step1_pdbreader_temp.inp'
    fix_pdb = './charmm_script/step1_pdbreader.pdb'
    drop_h_pdb = './charmm_script/drop_h.pdb'
